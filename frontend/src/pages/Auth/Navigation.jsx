  ...
  return (
    <div>
      ...
      <div
        ...
        } xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-[#000] w-[4%] hover:w-[15%] h-[100vh] fixed transition-transform duration-300`}
      ...
      >
        <div className="flex flex-col justify-center space-y-4">
          ...
          <Link to="/cart" className="flex items-center transition-transform transform hover:translate-x-2">
            ...
            {cartItems.length > 0 && (
              <span className="px-1 py-0 text-sm text-white bg-pink-500 rounded-full absolute top-9">
            ...
            <div>
              ...
              >
                <div className="flex items-center justify-center gap-3">
                  <b className="bg-pink-500 text-white flex items-center justify-center rounded-[50px] w-[40px] h-[40px] p-2 text-center uppercase">
                    ...
                    {userInfo.username.split(" ")[1]?.charAt(0)}
                  </b>
              ...
              {dropdownOpen && (
                <ul className="absolute right-0 mt-2 mr-14 space-y-2 bg-white text-gray-600">
                  ...
                  <li><button onClick={logoutHandler} className="block w-full px-4 py-2 text-left hover:bg-gray-100">Logout</button></li>
                </ul>
              )}
            </div>
          ) : (
